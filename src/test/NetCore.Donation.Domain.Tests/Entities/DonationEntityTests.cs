...
public class DonationEntityTests
{
    ...
    public void PaymentScheduleRaiseDonationCreated_RaisesDonationCreated()
    {
        ...
        schedule.RaiseDonationCreated(PaymentType.PayPal);
    ...
    [TestMethod]
    public void PaymentScheduleRaiseDonationCreated_WhenOneOff_IsNotRecurring()
    {
        var schedule = PaymentSchedule.Create(
            Guid.NewGuid(),
            Guid.NewGuid(),
        ...
        schedule.RaiseDonationCreated(PaymentType.Bank);

        var domainEvent = (DonationCreatedDomainEvent)schedule.DomainEvents.Single();
        Assert.IsFalse(domainEvent.IsRecurring);
        Assert.AreEqual(RecurringInterval.OneOff, domainEvent.RecurringInterval);
    }
}